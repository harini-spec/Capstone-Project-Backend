...
namespace HealthTracker.Migrations
{
    ...
    [Migration("20240725091523_target-column-for-healthlog")]
    partial class targetcolumnforhealthlog
    {
            ...
            modelBuilder.Entity("HealthTracker.Models.DBModels.HealthLog", b =>
                {
                    ...
                    b.HasOne("HealthTracker.Models.DBModels.Target", "TargetForHealthLog")
                        .WithMany()
                        .HasForeignKey("TargetId");

                    b.Navigation("HealthLogForPreference");

                    b.Navigation("TargetForHealthLog");
                });
